import { z } from 'zod';
import { BasemapKeySchema, StyleTypeSchema, GraduatedMethodSchema, LabelPositionSchema, FontWeightSchema, PopupTypeSchema, HoverDisplaySchema, LegendPositionSchema, ControlTypeSchema, } from '../schemas/enums.js';
...
export function resolveLayerConfig(slug, minimal, geojson, defaultPalette = 'Vintage') {
    ...
    if (isPoint) {
        ...
        style = {
            type: ms.type ?? 'simple',
            default_color: ms.default_color ?? DEFAULT_POLYGON_STYLE.default_color,
