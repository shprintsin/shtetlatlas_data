...
| historical_name | Historical name of the settlement |
| settlement_type | Type of settlement (Miasto = town, Miasteczko = small town, Wieś = village) |
| jewish_pop | Jewish population of the principal settlement |
| year | Census year (1765) |
| region | Region code (BRT = Bracław) |
| geocode | Unique geographic code in the format {region}_{kahal_name} |
| source | Data source identifier (YGZ) |
